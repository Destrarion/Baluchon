...
class TranslateAPITests: XCTestCase {
    ...
    func testGetTranslationShouldPostFailedIfIncorrectData() {
        let translate = Translate(translateSession: URLSessionFake(data: FakeResponseData.rateIncorrectData, response: FakeResponseData.responseOK, error: nil))
    ...
    func testGetTranslationShouldPostFailedCallbackIfNoErroreAndCorrectData() {
        let translate = Translate(translateSession: URLSessionFake(data: FakeResponseData.rateCorrectData, response: FakeResponseData.responseKO, error: nil))
